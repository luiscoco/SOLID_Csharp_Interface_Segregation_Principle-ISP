# SOLID_Csharp_Interface_Segregation_Principle-ISP

## Interface Segregation Principle (ISP):
The ISP suggests that clients should not be forced to depend on interfaces they don't use. 
It promotes the idea of smaller, specific interfaces rather than large, general-purpose ones, reducing the coupling between classes and improving code maintainability.
